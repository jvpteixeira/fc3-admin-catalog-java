...
CREATE TABLE videos (
    ...
    oped BOOLEAN NOT NULL DEFAULT FALSE,
    ...
    CONSTRAINT fk_v_thumb_id FOREIGN KEY (thumb_id) REFERENCES videos_image_media (id) ON DELETE CASCADE,
    CONSTRAINT fk_v_thumb_half_id FOREIGN KEY (thumb_half_id) REFERENCES videos_image_media (id) ON DELETE CASCADE,
);
...
CREATE TABLE videos_categories (
    ...
    CONSTRAINT fk_vcs_category_id FOREIGN KEY (video_id) REFERENCES categories (id),
);

CREATE TABLE videos_genres (
    video_id CHAR(32) NOT NULL,
    genre_id CHAR(32) NOT NULL,
    CONSTRAINT idx_vgs_video_category UNIQUE(video_id, genre_id),
...
--    CONSTRAINT fk_vcms_genre_id FOREIGN KEY (cast_member) REFERENCES cast_member (id),
--);
